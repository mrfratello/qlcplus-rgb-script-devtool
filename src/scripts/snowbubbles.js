...
(function () {
  ...
  algo.windchill = 0;
  algo.properties.push(
    'name:windchill|type:list|display:Windchill|values:No,Yes|write:setWindchill|read:getWindchill'
  );
  algo.reverse = 0;
  algo.properties.push(
    'name:reverse|type:list|display:Bottom-to-top|values:No,Yes|write:setReverse|read:getReverse'
  );
