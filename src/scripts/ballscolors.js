...
(function () {
  ...
  var algo = new Object();
  algo.apiVersion = 2;
  algo.name = 'Duplicate Balls (Colors)';
      ...
      for (var ry = my - boxSize; ry < my + boxSize + 2; ry++) {
        ...
        for (var rx = mx - boxSize; rx < mx + boxSize + 2; rx++) {
          ...
          if (rx < width && rx > -1 && ry < height && ry > -1) {
            // if edges are off the map dont draw
            ...
            var hyp =
              1 -
              Math.sqrt(offx * offx + offy * offy) / (algo.presetSize / 2 + 1);
